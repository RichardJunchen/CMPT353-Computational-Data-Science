...
dataframe = pd.DataFrame(list_of_whole,columns = ['train_score','valid_score','situation'],index = ['right_foot_1','right_foot_2','right_foot_3','female_1','female_2','injury','injury_1','injury_2'])
...
def main():
    ...
    G_model.predict(X_check)
    print("\n")
    print("The result of input file in injury classifier is (Note 1 means injury; 0 means not injury) ", G_model.predict(X_check))
